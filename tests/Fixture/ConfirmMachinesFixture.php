...
/**
 * ConfirmMachinesFixture
 *
 */
class ConfirmMachinesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'oxygen_enricher_type' => ['type' => 'string', 'fixed' => true, 'length' => 1, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '1：３Lタイプ、2：５Lタイプ、3：7Lタイプ', 'precision' => null],
        'is_humidifier' => ['type' => 'string', 'fixed' => true, 'length' => 1, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '1：加湿器あり、0：加湿器なし', 'precision' => null],
        'oxygen_enricher_specification' => ['type' => 'string', 'fixed' => true, 'length' => 1, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '2：他メーカー、1：大陽日酸機器、0:指定なし', 'precision' => null],
        'oxygen_enricher_name' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'child_device_type' => ['type' => 'string', 'fixed' => true, 'length' => 1, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '1：ヘリオスH300、2：ほたる、0：特定機種なし', 'precision' => null],
        ...
        'valve_type' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'flow_controller_type' => ['type' => 'string', 'fixed' => true, 'length' => 1, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '1：機種指定、0：機種指定なし', 'precision' => null],
        'flow_controller_name' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'respiration_tuner_type' => ['type' => 'string', 'fixed' => true, 'length' => 1, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '1：機種指定、0：機種指定なし', 'precision' => null],
        'respiration_tuner_name' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'oxygen_enricher_type' => 'Lorem ipsum dolor sit ame',
            'is_humidifier' => 'Lorem ipsum dolor sit ame',
            'oxygen_enricher_specification' => 'Lorem ipsum dolor sit ame',
            'oxygen_enricher_name' => 'Lorem ipsum dolor sit amet',
            'liquid_oxygen_parent_device_type' => 'Lorem ipsum dolor sit ame',
            'is_child_device' => 'Lorem ipsum dolor sit ame',
            'child_device_type' => 'Lorem ipsum dolor sit ame',
            ...
            'valve_type' => 'Lorem ipsum dolor sit amet',
            'is_flow_controller' => 'Lorem ipsum dolor sit ame',
            'flow_controller_type' => 'Lorem ipsum dolor sit ame',
            'flow_controller_name' => 'Lorem ipsum dolor sit amet',
            ...
            'respiration_tuner_type' => 'Lorem ipsum dolor sit ame',
            'respiration_tuner_name' => 'Lorem ipsum dolor sit amet',
            ...
            'updated_at' => '2017-01-24 12:40:25',
            'updated_by' => '86da3700-704b-4133-bc9a-445d0388c7b9',
            'created_at' => '2017-01-24 12:40:25',
            'created_by' => '0a126750-4c02-4780-85ca-f56294bf625b'
        ],
    ];
}
